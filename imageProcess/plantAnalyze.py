...
def main():
    ...
    # img_binary = pcv.threshold.binary(a, 150, 255, 'dark')
    ...
    roi_contour, roi_hierarchy = pcv.roi.rectangle(img, 10, 10, 700, 1200)
    ...
    clusters_i, contours, hierarchies = pcv.cluster_contours(img, roi_objects, roi_obj_hierarchy, 4, 6)
    ...
    output_path = pcv.cluster_contour_splitimg(img, clusters_i, contours, hierarchies, out, file=filename, filenames=names)
